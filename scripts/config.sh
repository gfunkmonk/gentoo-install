...
USED_ZFS=false
# Flag to track usage of jfs
USED_JFS=false
# Flag to track usage of reiserfs
USED_REISERFS=false
...
#   root_fs=[ext4|jfs|reiserfs|xfs|btrfs]  Root filesystem. Defaults to ext4 if not given.
...
#   type=[efi|bios]       Selects the boot type. Defaults to efi if not given.
#   luks=[true|false]     Encrypt root partition. Defaults to true if not given.
#   root_fs=[ext4|jfs|xfs|reiserfs|btrfs]  Root filesystem. Defaults to ext4 if not given.
